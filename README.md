# automation_example
This is an example of test automation using the [**UITAF**](https://uitaf.org) open-source project for UI testing.

The test is designed to validate the Tricentis Vehicle Insurance Quote application available at [http://sampleapp.tricentis.com/101/](http://sampleapp.tricentis.com/101/) using the Chrome browser.
